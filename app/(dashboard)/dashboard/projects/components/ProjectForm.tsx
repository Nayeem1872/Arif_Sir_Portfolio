      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          {isEditing && project?.thumbnailImage && (
            <div className="mb-3">
              <p className="text-text-muted mb-2 text-sm">Current thumbnail:</p>
              <img
        ...
        <div>
          ...
          {isEditing &&
            ...
            existingImages.some(
              ...
              <div className="mb-4">
                <p className="text-text-muted mb-2 text-sm">Current images:</p>
        ...
        <div>
          <div className="mb-2 flex items-center justify-between">
            <label className="text-fg text-sm font-medium">Technologies</label>
            <button
              type="button"
